...
//GIE stands for General interuupt register 
//_BIS_SR simply stands for Bit Set. It's a status resgister in the msp430 that allows users to enable registers. 